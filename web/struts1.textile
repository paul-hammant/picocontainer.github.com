...
<web-app>  
  ...
  <filter>  
    ...
    <filter-class>com.picocontainer.web.struts.PicoActionFactory$ServletFilter</filter-class>  
  </filter>  
...
{% highlight xml %}
  <form-beans>  
    <form-bean name="cheeseForm" type="com.picocontainer.web.sample.struts.CheeseForm">  
    </form-bean>  
  </form-beans>  
  
  <action-mappings>  
    <action path="/cheese" type="com.picocontainer.web.sample.struts.CheeseAction" name="cheeseForm" scope="request">  
      <forward name="next" path="/cheese.jsp">  
    </forward></action>  
  </action-mappings>  
  
  <controller processorclass="com.picocontainer.web.struts.PicoRequestProcessor">        
  </controller>
{% endhighlight %}
