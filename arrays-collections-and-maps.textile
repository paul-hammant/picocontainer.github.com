...
p. Authors: Aslak Hellesøy, Jörg Schaible
...
pico.addComponent(Shark.class);
pico.addComponent(Cod.class);
pico.addComponent(Bowl.class, Bowl.class, new ComponentParameter(Fish.class, false), new ComponentParameter(Cod.class, false));
{% endhighlight %}
...
public static class GenericBowl {
  ...
  private final Collection<Cod> cods;

  public GenericBowl(List<Fish> fishes, Collection<Cod> cods) {
    this.fishes = fishes; this.cods = cods;
  }
...
p. As for plain collection types, PicoContainer cannot detect the type of the components, that should be part of the collection on its own. Again you must use a special constructor of "ComponentParameter":/javadoc/core/com/picocontainer/parameters/ComponentParameter.html and define the component's type:
...
pico.addComponent(Shark.class)
	...
	.addComponent(Bowl.class)
	.addComponent(new Fish[]{});
...
pico.addComponent(Shark.class)
	.addComponent(Cod.class)
	.addComponent(Bowl.class, Bowl.class, 
			new ComponentParameter(Fish.class, false), 
			new ComponentParameter(Cod.class, false))
	.addComponent(set);
...
p. But how can you circumvent such a situation and ensure that the collective type is generated even if one of the same type was registered? Make usage of the "CollectionComponentParameter":/javadoc/core/com/picocontainer/parameters/CollectionComponentParameter.html . Example code for an Array:
...
MutablePicoContainer parent = new DefaultPicoContainer()
	.addComponent("Tom", Cod.class);
	.addComponent("Harry", Cod.class);

 
MutablePicoContainer child = new DefaultPicoContainer(parent)
	.addComponent("Dick", Cod.class); 
	.addComponent(Bowl.class, Bowl.class, 
				new ComponentParameter(Fish.class, false), 
				new ComponentParameter(Cod.class, false)); 
...
p. Although filtering on component type or key type is useful, it might not be enough. Therefore you can add an additional and completely individual filter by overloading "CollectionComponentParameter.evaluate(ComponentAdapter)":/javadoc/core/com/picocontainer/parameters/CollectionComponentParameter.html#evaluate(com.picocontainer.ComponentAdapter)) . See the example code to filter out the Cod named _Tom_ :
...
MutablePicoContainer pico = new DefaultPicoContainer()
	...
	.addComponent("Dick", Cod.class)
	.addComponent("Harry", Cod.class)
	.addComponent("Sharky", Shark.class)
	.addComponent(Bowl.class, Bowl.class, 
		new CollectionComponentParameter(Fish.class, false), 
...
p. An even more advanced filter mechanism is using the "Constraint":/javadoc/gems/com/picocontainer/gems/constraints/package-summary.html extension as provided in the "PicoContainer-Gems" project.
