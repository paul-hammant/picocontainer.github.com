...
com.picocontainer.injectors ".AbstractInjector$AmbiguousComponentResolutionExceptio":/javadoc/core/org/picocontainer/injectors/AbstractInjector.AmbiguousComponentResolutionException.html n: class<Something Here>needs a '<Something Here>' injected, but there are too many choices to inject. These:[class<Something Here>, class<Something Here>], refer http://picocontainer.org/help/ambiguous-injectable-help.html at com.picocontainer.parameters.BasicComponentParameter.getTargetAdapter(BasicComponentParameter.java:270) at com.picocontainer.parameters.BasicComponentParameter.resolveAdapter(BasicComponentParameter.java:205) at com.picocontainer.parameters.BasicComponentParameter.isResolvable(BasicComponentParameter.java:136) at com.picocontainer.parameters.ComponentParameter.isResolvable(ComponentParameter.java:132) at com.picocontainer.injectors.ConstructorInjector.getGreediestSatisfiableConstructor(ConstructorInjector.java:105) at com.picocontainer.injectors.ConstructorInjector$1.run(ConstructorInjector.java:155) at com.picocontainer.injectors.AbstractInjector$ThreadLocalCyclicDependencyGuard.observe(AbstractInjector.java:262) at com.picocontainer.injectors.ConstructorInjector.getComponentInstance(ConstructorInjector.java:192) at com.picocontainer.injectors.AbstractInjector.getComponentInstance(AbstractInjector.java:103) at com.picocontainer.DefaultPicoContainer.getInstance(DefaultPicoContainer.java:559) at com.picocontainer.DefaultPicoContainer.getComponent(DefaultPicoContainer.java:526) at com.picocontainer.DefaultPicoContainer.getComponent(DefaultPicoContainer.java:538)
	
p. Or possibly a _CyclicDependencyException_ like this:

com.picocontainer.injectors. "AbstractInjector$CyclicDependencyException":/javadoc/core/org/picocontainer/injectors/AbstractInjector.CyclicDependencyException.html : Cyclic dependency: [class<Something Here>, class<Something Here>, class<Something Here>] at com.picocontainer.injectors.AbstractInjector$ThreadLocalCyclicDependencyGuard.observe(AbstractInjector.java:257) at com.picocontainer.injectors.ConstructorInjector.getComponentInstance(ConstructorInjector.java:192) at com.picocontainer.behaviors.AbstractBehavior.getComponentInstance(AbstractBehavior.java:65) at com.picocontainer.behaviors.Stored.getComponentInstance(Stored.java:85) at com.picocontainer.behaviors.AbstractBehavior.getComponentInstance(AbstractBehavior.java:61) at com.picocontainer.DefaultPicoContainer.getInstance(DefaultPicoContainer.java:559) at com.picocontainer.DefaultPicoContainer.getComponent(DefaultPicoContainer.java:526) at com.picocontainer.DefaultPicoContainer.getComponent(DefaultPicoContainer.java:516) at com.picocontainer.parameters.BasicComponentParameter.resolveInstance(BasicComponentParameter.java:146) at com.picocontainer.parameters.ComponentParameter.resolveInstance(ComponentParameter.java:119) at com.picocontainer.injectors.SingleMemberInjector.getMemberArguments(SingleMemberInjector.java:89) at com.picocontainer.injectors.ConstructorInjector.getMemberArguments(ConstructorInjector.java:199) at com.picocontainer.injectors.ConstructorInjector$1.run(ConstructorInjector.java:162) at com.picocontainer.injectors.AbstractInjector$ThreadLocalCyclicDependencyGuard.observe(AbstractInjector.java:262) at com.picocontainer.injectors.ConstructorInjector.getComponentInstance(ConstructorInjector.java:192) at com.picocontainer.behaviors.AbstractBehavior.getComponentInstance(AbstractBehavior.java:65) at com.picocontainer.behaviors.Stored.getComponentInstance(Stored.java:85) at com.picocontainer.behaviors.AbstractBehavior.getComponentInstance(AbstractBehavior.java:61) at com.picocontainer.DefaultPicoContainer.getInstance(DefaultPicoContainer.java:559) at com.picocontainer.DefaultPicoContainer.getComponent(DefaultPicoContainer.java:526) at com.picocontainer.DefaultPicoContainer.getComponent(DefaultPicoContainer.java:516) at com.picocontainer.parameters.BasicComponentParameter.resolveInstance(BasicComponentParameter.java:146) at com.picocontainer.parameters.ComponentParameter.resolveInstance(ComponentParameter.java:119) at com.picocontainer.injectors.SingleMemberInjector.getMemberArguments(SingleMemberInjector.java:89) at com.picocontainer.injectors.ConstructorInjector.getMemberArguments(ConstructorInjector.java:199) at com.picocontainer.injectors.ConstructorInjector$1.run(ConstructorInjector.java:162) at com.picocontainer.injectors.AbstractInjector$ThreadLocalCyclicDependencyGuard.observe(AbstractInjector.java:262) at com.picocontainer.injectors.ConstructorInjector.getComponentInstance(ConstructorInjector.java:192) at com.picocontainer.behaviors.AbstractBehavior.getComponentInstance(AbstractBehavior.java:65) at com.picocontainer.behaviors.Stored.getComponentInstance(Stored.java:85) at com.picocontainer.behaviors.AbstractBehavior.getComponentInstance(AbstractBehavior.java:61) at com.picocontainer.DefaultPicoContainer.getInstance(DefaultPicoContainer.java:559) at com.picocontainer.DefaultPicoContainer.getComponent(DefaultPicoContainer.java:526) at com.picocontainer.DefaultPicoContainer.getComponent(DefaultPicoContainer.java:538)
...
p. Careful examination of MutablePicoContainer.addComponent() will show an optional last object that takes a variable number of com.picocontainer.Parameter objects. Without going into the specifics yet, the general rule is that if you specify three parameter objects in your addComponent() registration, then you will use the constructor that takes three parameters in your object. Use Parameter.ZERO to force the default constructor.
